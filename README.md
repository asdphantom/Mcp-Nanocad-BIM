...
`create_bim_dome_roof`, `create_bim_loft_roof` и `create_bim_sweep_roof`
добавляют три варианта нативной крыши. `create_bim_slab`, `create_bim_roof`
